 ...
 *
 * Разница между функциями осталась одна, и она про СЕРВЕР: у счёта чтение
 * реестра открыто при выключенной подписке (клиента нельзя лишать уже
 * выставленных документов), у БДДС закрыто всё, включая чтение, — там нет
 * документа, есть только расчёт, и он и есть предмет подписки.
 *
