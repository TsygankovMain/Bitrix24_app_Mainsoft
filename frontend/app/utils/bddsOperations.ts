 ...
 * человека надо вести в «Настройки → Настройка полей», а не в поддержку.
 * Тот же смысл, что у серверного кода finance_spa_not_configured, и тот же
 * адрес, что в bddsErrors.ts — текст один, чтобы человек не получил два
 * разных объяснения одной причины.
 */
...
export const BDDS_OPERATIONS_SETTINGS_PATH = '/settings/mapping'

export const BDDS_OPERATIONS_SETTINGS_LABEL = 'Настройка полей'
