 ...
 * usePortalFeatures (ключ PORTAL_FEATURES_STATE_KEY, запрос /api/features),
 * потому что ручка ОДНА на все платные функции портала и зовёт её бутстрап
 * приложения (useAppInit.initApp). Здесь только своя трактовка того же
 * ответа: свой код функции и свой аварийный выключатель.
 *
