...
<template>
  ...
  >
    ...
    <div v-if="!isManager && access.enabled" class="ms-note ms-note-info">
      ...
      <p class="mt-1">
        Собирать счёт могут админ портала и сотрудники с ролью «Бухгалтерия» — роли назначаются в
        «Настройки → Роли и права». Предпросмотр сервер тоже закрывает: он показывает суммы к
        выставлению, а не отчёт.
      </p>
    </div>
